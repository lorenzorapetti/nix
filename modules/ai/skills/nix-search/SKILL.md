---
name: nix-search
description: Search and query NixOS packages and options using nix-search-tv. Use when you need to find packages, get package details, view source code locations, or find NixOS/Home Manager options.
---
