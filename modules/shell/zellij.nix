{
  den.aspects.shell = {
    homeManager = {
      ...
      xdg.configFile."zellij/config.kdl".text = ''
        keybinds clear-defaults=true {
            ...
            shared_among "normal" "locked" {
                ...
                bind "Alt v" { NewPane "down"; SwitchToMode "locked"; }
                bind "Alt s" { NewPane "right"; SwitchToMode "locked"; }
        ...
        plugins {
            ...
            navigator location="file:$HOME/.config/zellij/plugins/vim-zellij-navigator.wasm"
        }
      ...
      xdg.configFile."zellij/zellij-urlview/zellij-urlview.sh" = {
        executable = true;
        text = ''
          #!/usr/bin/env bash
